...
'session.serialization','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'debugbar.options.db.timeline','debugbar.options.db.duration_background','debugbar.options.db.explain','debugbar.options.db.show_query_result','debugbar.options.db.only_slow_queries',
...
'debugbar.telescope','sanctum.csrf-cookie',
'telescope','api.customers.index','api.customers.store','api.customers.show',
'api.accounts.index','api.accounts.store','api.accounts.show','api.accounts.balance','api.accounts.ledger',
'api.transaction.index','api.transaction.deposit','api.transaction.withdraw','api.transaction.transfer','api.transaction.retry',
'api.transaction.show','dashboard','profile.edit',
